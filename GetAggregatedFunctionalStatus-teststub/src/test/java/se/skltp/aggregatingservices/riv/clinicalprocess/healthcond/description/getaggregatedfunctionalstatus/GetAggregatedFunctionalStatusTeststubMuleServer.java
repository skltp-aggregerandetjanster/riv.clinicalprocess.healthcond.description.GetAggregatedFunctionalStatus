...
public class GetAggregatedFunctionalStatusTeststubMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedFunctionalStatus-teststub";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedFunctionalStatusTeststubMuleServer.class);
