...
public class GetAggregatedFunctionalStatusMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedFunctionalStatus";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedFunctionalStatusMuleServer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Note: Actually enables the spring-beans-profile soitoolkit-teststubs in the file GetAggregatedFunctionalStatus-common.xml
        //
        // Arg #3: Start services if true
        // Note: Actually loads all *-service.xml files that are specified in the file mule-deploy.properties
